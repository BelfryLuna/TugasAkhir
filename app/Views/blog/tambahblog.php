...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
            <h2 class="font-w600 title mb-2 mr-auto">Tambah Post</h2>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form class="form-valide-with-icon" action="/blog/saveblog" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <div class="form-group">
                                    <label class="text-label" for="judul1">Judul</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control <?php if (session('errors.judul')) : ?>is-invalid<?php endif ?>" id="judul1" name="judul">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="form-group mb-0 d-inline">
                                            <label class="radio-inline mr-3"><input type="radio" name="kategori" value="Basis Pengetahuan"> Basis Pengetahuan</label>
                                            <label class="radio-inline mr-3"><input type="radio" name="kategori" value="Penyakit Lambung"> Penyakit Lambung </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="text-label" for="editor">Konten</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <label for="customFile" class="custom-file-label">Tambahkan Gambar Post..</label>
                                        <img src="<?= base_url(); ?>/images/default.jpg" class="img-thumbnail img-preview mt-3" style="height: 110px; width: 120px;">
                                    </div>
                                </div>
