...
<section class="row_am how_it_works" id="how_it_work">
    ...
    <div class="container">
        ...
        <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
            <!-- h2 -->
            <h2>Detail  <span>Riwayat</span> Diagnosis</h2>
            <!-- p -->
            <p>Berikut adalah detail riwayat diagnosis awal Anda <br> Berdasarkan diagnosis yang telah dilakukan sebelumnya.</p>
        </div>
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="form-group mt-0 text-left">
                                            <label>Nama</label>
                                            <input type="text" class="form-control" name="nama" placeholder="<?= $bio['nama']; ?>" disabled>
                                        </div>
                                        <div class="form-group mt-3 text-left">
                                            <label>Usia</label>
                                            <input type="text" class="form-control" name="umur" placeholder="<?= $bio['umur']; ?>" disabled>
                                        </div>
                                        <div class="form-group mt-3 mb-4 text-left">
                                            <label>Jenis Kelamin</label>
                                            <input type="text" class="form-control" name="jk" placeholder="<?= $bio['jk']; ?>" disabled>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="col-xl-5 col-xxl-6">
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="section_title">
                                <h2><span><?= $hasilP[0]['nama_penyakit']; ?></span></h2>
                            </div>
                        </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="pt-4" style="text-align: justify;">
                                                    ...
                                                    <p><?= $hasilP[0]['pengobatan']; ?></p>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="profile" style="text-align: justify;">
                                                <div class="pt-4">
                                                    <h4>Solusi Pencegahan:</h4>
                                                    <p><?= $hasilP[0]['pencegahan']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="screen_slider" class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="screen_frame_img">
                                    <div class="card-bx stacked card">
                                        <!-- masukin gambar -->
                                        <img src="<?= base_url(); ?>/images/<?= $hasilP[0]['gambar']; ?>" name="gambar4" alt="">
                            ...
                            <div class="item">
                                <div class="screen_frame_img">
                                    <div class="card-bx stacked card">
                                        <!-- masukin gambar -->
                                        <img src="<?= base_url(); ?>/images/<?= $hasilP[0]['gambar3']; ?>" name="gambar4" alt="">
                                        <!-- masukin keterangan atas -->
                                        <div class="card-info">
                            ...
                            <div class="item">
                                <div class="screen_frame_img">
                                    <div class="card-bx stacked card">
                                        <!-- masukin gambar -->
                                        <img src="<?= base_url(); ?>/images/<?= $hasilP[0]['gambar4']; ?>" name="gambar4" alt="">
                                        <!-- masukin keterangan atas -->
                                        <div class="card-info">
                            ...
                            <div class="item">
                                <div class="screen_frame_img">
                                    <div class="card-bx stacked card">
                                        <!-- masukin gambar -->
                                        <img src="<?= base_url(); ?>/images/<?= $hasilP[0]['gambar5']; ?>" name="gambar4" alt="">
                                        <!-- masukin keterangan atas -->
                                        <div class="card-info">
                             ...
                             <div class="item">
                                <div class="screen_frame_img">
                                    <div class="card-bx stacked card">
                                        <!-- masukin gambar -->
                                        <img src="<?= base_url(); ?>/images/<?= $hasilP[0]['gambar2']; ?>" name="gambar4" alt="">
                                        <!-- masukin keterangan atas -->
                                        <div class="card-info">
                            ...
                            <div class="item">
                                <div class="screen_frame_img">
                                    <div class="card-bx stacked card">
                                        <!-- masukin gambar -->
                                        <img src="<?= base_url(); ?>/images/<?= $hasilP[0]['gambar6']; ?>" name="gambar4" alt="">
                                        <!-- masukin keterangan atas -->
                                        <div class="card-info">
